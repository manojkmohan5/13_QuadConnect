...
cd 13_QuadConnect
git switch feature/match-views          # your branch, already on the remote
...
python manage.py runserver          # http://127.0.0.1:8000/matches/ shows a stub
```

You should see a placeholder page at `/matches/` saying "Not implemented yet".
...
```
| Manojkumar Mohankumar | `feature/match-views` | FBV render() | <route> | DONE - <one line on what shipped> |
```
...
```markdown
### DONE `feature/match-views` - Manojkumar Mohankumar - YYYY-MM-DD
