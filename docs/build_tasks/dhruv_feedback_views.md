...
cd 13_QuadConnect
git switch feature/feedback-views          # your branch, already on the remote
...
python manage.py runserver          # http://127.0.0.1:8000/feedback/summary/ shows a stub
```

You should see a placeholder page at `/feedback/summary/` saying "Not implemented yet".
...
```
| Dhruv Thaker | `feature/feedback-views` | FBV HttpResponse | <route> | DONE - <one line on what shipped> |
```
...
```markdown
### DONE `feature/feedback-views` - Dhruv Thaker - YYYY-MM-DD
